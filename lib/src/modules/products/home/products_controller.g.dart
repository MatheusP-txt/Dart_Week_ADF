...
mixin _$ProductsController on ProductsControllerBase, Store {
  ...
  late final _$_productSlectedAtom =
      Atom(name: 'ProductsControllerBase._productSlected', context: context);

  ProductModel? get productSlected {
    _$_productSlectedAtom.reportRead();
    return super._productSlected;
  }

  @override
  ProductModel? get _productSlected => productSlected;

  @override
  set _productSlected(ProductModel? value) {
    _$_productSlectedAtom.reportWrite(value, super._productSlected, () {
      super._productSlected = value;
    });
  }
